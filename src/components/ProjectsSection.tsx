...
techStack: ["Python", "LangChain", "FAISS", "LLM", "Streamlit","Groq API"],
    ...
    },
    {
      ...
      description:
        "Scraped 5,000+ listings using Selenium. Built interactive Streamlit dashboard.",
    ...
    },
    {
      ...
      description:
        "Clickstream analysis to understand online shopping behavior.",
    ...
    },
    {
      ...
      description:
        "Business insights dashboard for decision-making using sales data.",
    ...
    },
    {
      ...
      description:
        "End-to-end document automation with Donut (Vision Transformer), LlamaParse, OCR+LLM fallback, and validation layers. Trained Donut on 100K docs, built ground truth for 10+ doc types, tested beta LLaMA extractor agents. Scaled to 60K+ docs/month with 92% accuracy, reducing errors and enabling compliance-ready insights.",
      techStack: [
        "Donut",
        "Vision Transformer",
        "LlamaParse",
    ...
    },
    {
      ...
      description:
        "Built a Python + Pandas pipeline to extract insights from S3 log files (classification latency, validation errors, SQL upload status). Automated ingestion with n8n, stored insights in Google Sheets, and built Looker Studio dashboards for monitoring 60K+ docs/month in real time.",
      techStack: [
        "Python",
        "Pandas",
        "AWS S3",
    ...
    },
    {
      ...
      description:
        "Developed RAG chatbot using Streamlit, FAISS vector DB, and HuggingFace embeddings. Integrated Groq LLaMA3-70B + CrewAI agents to combine semantic search over 100+ arXiv papers with real-time news responses, reducing query time by ~60% and boosting engagement by ~40%.",
      techStack: [
        "Python",
        "Streamlit",
        "LangChain",
    ...
    },
    {
      ...
      description:
        "Processed 2M+ crime records with Python + SQL for ETL, built Power BI dashboards with heatmaps, trends, and arrest analytics. Delivered policy insights for crime-prone zones, improving intervention planning by 20% in pilot testing.",
    ...
    },
    {
      ...
      description:
        "End-to-end data pipeline with Python + SQL for multi-source integration. Built Power BI dashboards on store performance, customer segmentation, and pricing strategies. Identified 15%+ growth opportunities through store-level targeting and product mix optimization.",
      techStack: [
        "SQL",
        "Python",
        "Power BI",
    ...
    },
    {
      ...
      description:
        "Developed and deployed an ML app using Logistic Regression, Random Forest, and XGBoost on Portuguese bank marketing data (45K+ records). Achieved AUC score of 0.93, boosting targeted marketing efficiency by ~35%. Deployed via Streamlit on AWS EC2 for real-time client scoring.",
      techStack: [
        "Python",
        "EDA",
        "Feature Engineering",
  ...
  return (
    <section id="projects" className="py-20 px-4 relative overflow-hidden">
      ...
      <div
        ...
        style={{ top: "30%", right: "-20%", width: "70%", transform: "rotate(165deg)" }}
      ></div>
      <div
        className="light-ray-premium opacity-15"
        style={{ top: "60%", right: "-10%", width: "50%", transform: "rotate(150deg)" }}
      ></div>
            ...
            >
              ...
              >
                <div className="p-6 h-full flex flex-col relative z-10">
                  ...
                  {/* 🌟 Embed Loom Video if available */}
                  {project.loomUrls && (
                    <div className="space-y-4 mb-6">
                      {project.loomUrls.map((loom, i) => (
                        <div
                          key={i}
